...
from PyQt5.QtWidgets import QVBoxLayout, QHBoxLayout, QLabel, QSlider, QColorDialog, QPushButton, QListWidget, QListWidgetItem, QInputDialog, QWidget, QSplitter
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.sidebar_widget = SidebarWidget(self,self.gl_widget)
    ...
    def setup_ui(self):
        ...
        self.splitter.addWidget(self.folium_widget)

        self.splitter.setSizes([100, 500, 500])  # Set initial sizes for each widget
    ...
    def get_panorama(self):
        self.image, self.depth, self.heading, self.latitude, self.longitude = process_location(self.clipboard_lat,
                                                                                                self.clipboard_lng)
